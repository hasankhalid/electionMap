...
function makeProvMaps() {
				...
				function drawProvincial(error, topology, prov_topology, prov2013, prov_seats_2013) {
								...
								d3.selectAll("#NA, #dwvs, #flow").attr('disabled', true);
								...
								if (error) {
												...
												var end_force = function end_force() {
																...
																d3.selectAll("#NA, #dwvs, #flow").attr('disabled', null);
												};
												...
												var translateAndScaleProvincialSeats = function translateAndScaleProvincialSeats(translate) {
																...
																d3.selectAll(".pSeatCircle").transition('zoom_trans').duration(300).style('opacity', '1').call(waitForAllTransitions, function () {
																				sp.resolve(translate);
																});
